...
export interface ApiEnkryptNetworkEnkryptNetwork
  extends Struct.CollectionTypeSchema {
  collectionName: 'enkrypt_networks';
  info: {
    description: '';
    displayName: 'enkrypt-network';
    pluralName: 'enkrypt-networks';
    singularName: 'enkrypt-network';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    aboutEnkrypt: Schema.Attribute.RichText & Schema.Attribute.Required;
    aboutEnkryptTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'About Enkrypt'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::enkrypt-network.enkrypt-network'
    > &
      Schema.Attribute.Private;
    ...
    networkInfo: Schema.Attribute.RichText & Schema.Attribute.Required;
    networkInfoTitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'What is [network Name]?'>;
    ...
    pageTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Enkrypt: '>;
...
export interface ApiEthvmNftPageEthvmNftPage
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ETHcontract: Schema.Attribute.String;
    HTMLmeta: Schema.Attribute.Component<'html.htm-lmeta', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    NFTDescription: Schema.Attribute.Text;
    NFTName: Schema.Attribute.String;
    NFTwebsite: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    SocialLinks: Schema.Attribute.Component<'token.social-links', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatIsNFT: Schema.Attribute.String;
  };
}

export interface ApiEthvmTokenPageEthvmTokenPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'ethvm_token_pages';
  info: {
    description: '';
    displayName: 'ethvm-token-page';
    pluralName: 'ethvm-token-pages';
    singularName: 'ethvm-token-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ethvm-token-page.ethvm-token-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SocialLinks: Schema.Attribute.Component<'token.social-links', false>;
    TokenBaseInfo: Schema.Attribute.Component<'token.token-info-shared', false>;
    TokenDescription: Schema.Attribute.Text;
    tokenWebsite: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatIsToken: Schema.Attribute.String;
  };
}
...
export interface ApiMewFaqSectionMewFaqSection
  ...
  attributes: {
    ...
    sectionID: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    sectionOrder: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    sectionText: Schema.Attribute.Text;
...
export interface ApiMewFaqMewFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    orderInSection: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMewTokenPageMewTokenPage
  ...
  info: {
    description: '';
    displayName: 'mew-token-page';
    pluralName: 'mew-token-pages';
    singularName: 'mew-token-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    coingeckoId: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    htmlDescription: Schema.Attribute.Text & Schema.Attribute.Required;
    htmlTitle: Schema.Attribute.String & Schema.Attribute.Required;
    icon: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    isEnkrypt: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    isMewWallet: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mew-token-page.mew-token-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    walletDescription: Schema.Attribute.RichText & Schema.Attribute.Required;
    whatIsToken: Schema.Attribute.RichText & Schema.Attribute.Required;
  };
}
  ...
  attributes: {
    ...
    data_type: Schema.Attribute.Enumeration<
      [
        ...
        'crypto_defi',
        'stocks',
        'stocks_stocks_tech_ai',
        'stocks_stocks_growth',
        'stocks_stocks_large_cap',
        'stocks_stocks_consumer_brands',
        'stocks_stocks_value',
        'stocks_stocks_healthcare_biotech',
        'stocks_stocks_banks_fintech',
        'stocks_stocks_small_mid_cap',
        'stocks_etf_us',
        'stocks_etf_bond_fixed_income',
        'stocks_etf_commodities',
        'stocks_etf_international',
        'stocks_etf_tactical',
        'stocks_dividend_stocks',
        'stocks_dividend_growth',
        'stocks_dividend_bond',
        'stocks_dividend_cash_short_term',
        'stocks_dividend_high_yield',
        'stocks_innovation_disruptive_tech',
        'stocks_innovation_established_tech',
        'stocks_innovation_clean_energy_power',
        'stocks_innovation_crypto',
        'stocks_innovation_ev_future_mobility',
        'stocks_world_us_large_cap',
        'stocks_world_china_asia',
        'stocks_world_europe',
        'stocks_world_emerging_latin',
        'stocks_world_international_etfs',
        'stocks_strategy_capital_preservation',
        'stocks_strategy_index_passive_etf',
        'stocks_strategy_value_investing',
        'stocks_strategy_growth_investing',
        'stocks_strategy_small_cap_opportunity',
        'stocks_strategy_real_assets_commodities',
        'all',
      ]
    > &
      Schema.Attribute.Required;
